...
const INSTRUCTIONS = [
  ...
  "The draft is saved to Tyler's Tinker draft list and the result includes id. Pass id to update a saved draft.",
  "Pass kind \"dm\" for a direct message, or start the notes with \"DM:\". Pass currentDraft and an optional instruction to revise.",
  "This drafts copy only. Tyler posts them himself. Tinker never posts.",
...
const DRAFT_LINKEDIN_TOOL = {
  ...
  description: [
    ...
    "Drafts are saved to Tyler's Tinker draft list and the result includes id. Tyler posts them himself. Tinker never posts. It does not post, schedule, or publish to LinkedIn.",
